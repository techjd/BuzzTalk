 ...
 * Use the [AddUniversityNameFragment.newInstance] factory method to
...
class AddUniversityNameFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment AddUniversityNameFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            AddUniversityNameFragment().apply {
