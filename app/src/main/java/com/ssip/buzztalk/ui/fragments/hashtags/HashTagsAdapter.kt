...
import com.ssip.buzztalk.ui.fragments.home.adapter.PostsAdapter.PostsViewHolder

class HashTagsAdapter(
  val onClickListener: (String) -> Unit,
  val showToast: (String) -> Unit = {}
) :
  RecyclerView.Adapter<HashTagsAdapter.HashTagViewHolder>() {

  var posts: MutableList<com.ssip.buzztalk.models.hashtagfeeds.response.Post> = mutableListOf()

  inner class HashTagViewHolder(val itemPostBinding: ItemPostBinding) : RecyclerView.ViewHolder(itemPostBinding.root) {
  }
