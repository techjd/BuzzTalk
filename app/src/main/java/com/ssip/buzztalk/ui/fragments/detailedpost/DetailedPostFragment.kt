                ...
                SUCCESS -> {
                    with(binding) {
                        response?.let {
                            ...
                            val fullName =
                                "${response.data?.data?.post?.userId?.firstName} ${response.data?.data?.post?.userId?.lastName}"
        ...
        with(binding) {
            ...
            btnComment.setOnClickListener {
                ...
                if (comment.isNullOrEmpty()) {
                    Toast.makeText(requireContext(), "Comment can't be empty", Toast.LENGTH_SHORT)
                        .show()
                } else {
